...
public class Lodging implements Serializable {
	 ...
	 * @param id id for the object. If < 0 it will be auto generated. If it's not unique, will probably break things
	 * @param location Location enum for the location
	 * @param price the price in CENTS per room
	 ...
	 */
	public Lodging(int id, Location location, String checkIn, String checkOut, int price, int numRooms) throws java.text.ParseException {
		if (location == null) {
			throw new NullPointerException("Parameter location cannot be null");
		}
		this.location = location;
	...
	/**
	 * Constructor for a Lodging object using a csv-like one line string
	 ...
	 */
	public static Lodging fromCsv(String csvString) throws java.text.ParseException {
		String[] attrs = csvString.split(",");
		if (attrs.length != 6) {
			throw new java.text.ParseException("Invalid number of items in csv", 0);
		}
		
		return new Lodging(Integer.parseInt(attrs[0]), Location.valueOf(attrs[1]), attrs[2], attrs[3],
