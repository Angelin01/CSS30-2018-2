...
public interface InterfaceLodging extends Remote {
	 ...
	 */
	ArrayList<Lodging> getLodgings() throws RemoteException;
	 ...
	 * @throws RemoteException if there's any problem with the remote connection
	 */
	ArrayList<Lodging> getLodgings(Location location, int maxPrice, Date checkIn, Date checkOut, int minimumRooms) throws RemoteException;
